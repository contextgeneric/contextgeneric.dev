...
authors: [soares]
tags: [release]
description: 'CGP v0.6.1: implicit context types in provider impls, an attribute for checking individual provider layers, and associated types in getter traits.'
---
