...
authors: [soares]
tags: [release]
description: 'CGP v0.7.0 added cgp_fn, implicit, uses and use_type, the attributes that made providers read like ordinary Rust functions, and removed cgp_context.'
---
...
CGP v0.7.0 ships with preliminary support for [agent skills](https://agentskills.io/home) for LLMs. The [**CGP Skills**](/docs/ai/skills/) document is specifically written to teach LLMs about CGP in a compact way.
