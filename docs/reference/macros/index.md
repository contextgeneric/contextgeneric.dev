...
CGP's procedural macros cover a few kinds of work: defining a component and writing the providers that
...
Others build a provider from a plain function for CGP's computation family.
