...
`ToFieldsRef` adds one borrowing method to the borrowed-shape trait it extends:
...
[`HasExtractorRef`](../variant/has_extractor_ref.md) reads a variant without consuming the value.
