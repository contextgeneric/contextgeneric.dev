...
then calling the ordinary [`finalize_build`](../builder/finalize_build.md) is exactly what
[`CanFinalizeWithDefault`](../optional/can_finalize_with_default.md) does, and re-marking to `IsOptional` is what
[`ToOptional`](../optional/to_optional.md) does.
...
[`CanFinalizeWithDefault`](../optional/can_finalize_with_default.md):
