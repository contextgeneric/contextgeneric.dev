...
component and checks that the provider's own requirements are met. Three traits carry that, and you
...
The three build on one another. A context becomes a type-level table through
