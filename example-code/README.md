...
| `docs/reference/` | partial — `errors.md`, `macros/delegate_components.md`, all of `derives/`, and the `traits/` pages that show checkable code; the section is being filled in lazily |
