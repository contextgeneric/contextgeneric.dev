//! Runnable checks for the code shown on the `docs/cargo-cgp/` pages.
//!
//! One module per page, under `tests/cargo_cgp/`. See the crate `README.md` for the layout and for
