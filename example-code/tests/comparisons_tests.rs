//! Runnable checks for the code shown on the `docs/comparisons/` pages.
//!
//! One module per page, under `tests/comparisons/`. See the crate `README.md` for the layout and for
