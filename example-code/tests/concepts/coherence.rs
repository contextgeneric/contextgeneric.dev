...
///
/// Rejected snippet — trybuild fixture `tests/compile_fail/concepts/coherence_every_lookup_finds_the_same_answer_1.rs`.
///
/// The orphan rule. Neither `Display` nor `Vec<u8>` belongs to this crate:
///
/// Rejected snippet — trybuild fixture `tests/compile_fail/concepts/coherence_every_lookup_finds_the_same_answer_2.rs`.
...
///
/// Rejected snippet — trybuild fixture `tests/compile_fail/concepts/coherence_the_shape_stops_scaling.rs`.
