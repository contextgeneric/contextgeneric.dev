...
///
/// Rejected snippet — trybuild fixture `tests/compile_fail/reference/derives/derive_build_field_rejected_incomplete_build.rs`.
...
///
/// Rejected snippet — trybuild fixture `tests/compile_fail/reference/derives/derive_build_field_rejected_read_of_an_unset_field.rs`.
...
/// the source type.
///
/// Rejected snippet — trybuild fixture `tests/compile_fail/reference/derives/derive_build_field_rejected_build_from_without_has_fields.rs`.
