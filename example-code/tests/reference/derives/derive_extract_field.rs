...
///
/// Rejected snippet — trybuild fixture `tests/compile_fail/reference/derives/derive_extract_field_rejected_variant_shapes.rs`.
...
///
/// Rejected snippet — trybuild fixture `tests/compile_fail/reference/derives/derive_extract_field_rejected_premature_finalize.rs`.
