//! Runnable checks for the code shown on the `docs/tutorials/` pages.
//!
//! One module per page, under `tests/tutorials/`. See the crate `README.md` for the layout and for
